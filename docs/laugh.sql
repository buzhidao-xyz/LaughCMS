...
INSERT INTO `la_admin` (`id`, `username`, `password`, `ukey`, `createtime`, `status`, `ustate`, `lastlogintime`, `lastloginip`, `logincount`, `super`) VALUES
(1, 'admin', '206423eb45af33c046db62575e2522b2', 'gmk4r2', 1323910052, 1, '206423eb45af33c046db62575e2522b2', 1355228680, 2130706433, 43, 1),
(2, 'luochuan', '2edd3fc692b42f20c02e907b3c0488ca', 'u1itx6', 1324265773, 1, 'a1cb0b77413638a2974af70f948e16d8', 1354514400, 2130706433, 2, 0);
...
(1, '超级管理员', 1, '超级管理员 具有全站管理权限', 1332391671, 1355240806),
...
INSERT INTO `la_role_node` (`roleid`, `nodeid`, `access`) VALUES
(1, 10, 0),
(1, 5, 1),
(1, 8, 0),
(1, 4, 1),
