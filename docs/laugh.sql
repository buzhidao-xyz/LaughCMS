...
INSERT INTO `la_admin` (`id`, `username`, `password`, `ukey`, `createtime`, `status`, `ustate`, `lastlogintime`, `lastloginip`, `logincount`) VALUES
(1, 'admin', '206423eb45af33c046db62575e2522b2', 'gmk4r2', 1323910052, 1, '206423eb45af33c046db62575e2522b2', 1355144511, 2130706433, 94),
(2, 'luochuan', 'f3739d687fe0edfad83398420af74556', 'u1itx6', 1324265773, 1, 'a1cb0b77413638a2974af70f948e16d8', 1354514400, 2130706433, 2),
(3, 'test', 'a2907812388492fdf0f488bd5a3dc26d', '2fcy4o', 1325211617, 1, '', 0, NULL, 0),
(4, 'test123', '1f37cfc0e317e68390235a15d32a810f', '9w5ahf', 1355038369, 1, '1f37cfc0e317e68390235a15d32a810f', 1355038369, 2130706433, 0);
...
(3, '核心内容', 1332390538, 1332390538, 3, 1),
(4, '网站更新', 1332390538, 1332390538, 4, 1),
(5, '系统插件', 1332390538, 1332390538, 5, 1),
(6, '系统设置', 1353316335, 0, 0, 1);
...
INSERT INTO `la_node` (`id`, `title`, `remark`, `control`, `action`, `sort`, `pid`, `level`, `groupid`, `createtime`, `updatetime`, `isshow`) VALUES
(2, '角色管理', '管理角色信息 可编辑角色权限/改变用户的角色', '', '', 2, 0, 1, 1, 0, 0, 1),
(3, '日志管理', '日志模块', '', '', 3, 0, 1, 1, 0, 0, 1),
(4, '组管理', '节点组管理', '', '', 4, 0, 1, 1, 0, 0, 1),
(5, '节点管理', '管理模块下的节点信息', '', '', 5, 0, 1, 1, 0, 0, 1),
(6, '管理员用户管理', '管理员账号管理中心', '', '', 6, 0, 1, 1, 0, 0, 1),
(7, '用户搜索', '搜索用户信息', '', '', 1, 0, 1, 2, 0, 0, 1),
(8, '管理组', '', 'Group', 'manageGroup', 2, 4, 2, 0, 0, 0, 1),
(9, '添加节点', NULL, 'Node', 'newNode', 1, 5, 0, 0, 0, 0, 1),
(10, '管理节点', '', 'Node', 'manageNode', 0, 5, 0, 0, 1352711650, 0, 1),
(11, '添加角色', '', 'Role', 'newRole', 0, 2, 0, 0, 1352856214, 0, 1),
(12, '管理角色', '', 'Role', 'manageRole', 0, 2, 0, 0, 1352856238, 0, 1),
(13, '日志列表', '', 'Log', 'Index', 0, 3, 0, 0, 1352857554, 0, 1),
(14, '新管理员', '', 'Admin', 'newAdmin', 0, 6, 0, 0, 1352858914, 0, 1),
(15, '管理员列表', '', 'Admin', 'adminList', 0, 6, 0, 0, 1352944271, 0, 1),
(16, '栏目管理', '管理网站栏目', '', '', 0, 0, 0, 3, 1353313113, 0, 1),
(17, '网站栏目', '', 'Column', 'index', 0, 16, 0, 0, 1353313186, 0, 1),
(18, '文档管理', '', '', '', 0, 0, 0, 3, 1353316137, 0, 1),
(19, '发布新文档', '', 'Article', 'newArticle', 0, 18, 0, 0, 1353316212, 0, 1),
(20, '自动更新', '', '', '', 0, 0, 0, 4, 1353316369, 0, 1),
(21, '一键更新网站', '', 'Make', 'makeHtml', 0, 20, 0, 0, 1353316415, 0, 1),
(22, '更新系统缓存', '', 'System', 'upSystemCache', 0, 20, 0, 0, 1353316474, 0, 1),
(25, '基本设置', '', '', '', 0, 0, 0, 6, 1353316554, 0, 1),
(26, '数据库', '', '', '', 0, 0, 0, 6, 1353316597, 0, 1),
(23, '辅助插件', '', '', '', 0, 0, 0, 5, 1353316622, 0, 1),
(24, '文件管理器', '', 'FileManage', 'index', 0, 23, 0, 0, 1353316736, 0, 1);
...
INSERT INTO `la_role` (`id`, `name`, `status`, `remark`, `createtime`, `updatetime`) VALUES
(1, '超级管理员', 1, '超级管理员 具有全站管理权限', 1332391671, 1332391671),
(2, '管理员', 1, '普通管理员 管理某些模块', 1332391671, 1354171483);
...
INSERT INTO `la_role_admin` (`roleid`, `adminid`) VALUES
(2, 3),
(1, 3),
(1, 2),
(2, 2);
...
INSERT INTO `la_user` (`id`, `username`, `password`, `nickname`, `email`, `remark`, `ukey`, `createtime`, `status`, `ustate`, `urank`, `lastlogintime`, `lastloginip`, `logincount`) VALUES
