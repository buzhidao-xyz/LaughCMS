...
<div id="Header">
	<div id="HeaderMain">
		<div id="HeaderStatus">
			<div class="Logo">
				<a href="/laughcms/"><img src="/laughcms/themes/default/images/logo.png" /></a>
			</div>
			<div class="Center">
				Laugh CMS内容管理系统
			</div>
			<div class="Operate">
				...
				<div class="Search">
					<form method="POST" action="/laughcms/index.php?s=Search">
...
<ul class="headerNavigation">
		<li>
		<a href="/laughcms/index.php?s=Index/index&columnid=1" class="navon">网站首页</a>
			</li>
		<li>
		<a href="/laughcms/index.php?s=Article/lists&columnid=2" class="">新闻资讯</a>
				<ul class="SubNavigation">
						<li>
				<a href="/laughcms/index.php?s=Article/lists&columnid=3">IT知识</a>
								<ul>
										<li><a href="/laughcms/index.php?s=Article/lists&columnid=12">PHP知识</a></li>
									</ul>
							</li>
						<li>
				<a href="/laughcms/index.php?s=Article/lists&columnid=4">网络知识</a>
								<ul>
										<li><a href="/laughcms/index.php?s=Article/lists&columnid=5">前端知识</a></li>
									</ul>
							</li>
						<li>
				<a href="/laughcms/index.php?s=Article/lists&columnid=13">数据库知识</a>
							</li>
					</ul>
			</li>
		<li>
		<a href="/laughcms/index.php?s=Product/lists&columnid=6" class="">产品展示</a>
				<ul class="SubNavigation">
						<li>
				<a href="/laughcms/index.php?s=Product/lists&columnid=14">网络产品</a>
							</li>
						<li>
				<a href="/laughcms/index.php?s=Product/lists&columnid=15">电子产品</a>
							</li>
					</ul>
			</li>
		<li>
		<a href="/laughcms/index.php?s=Image/lists&columnid=7" class="">客户案例</a>
			</li>
		<li>
		<a href="/laughcms/index.php?s=Download/lists&columnid=8" class="">下载中心</a>
			</li>
		<li>
		<a href="/laughcms/index.php?s=Plugin/Cooperate&columnid=9" class="">招贤纳士</a>
			</li>
		<li>
		<a href="/laughcms/index.php?s=Public/index&columnid=10" class="">关于我们</a>
			</li>
		<li>
		<a href="/laughcms/index.php?s=Public/index&columnid=11" class="">联系我们</a>
			</li>
	</ul>
...
<div id="SImageContainer" class="slider">
	<div class="conbox">
				<div><a href="#" title="1"><img src="/laughcms/uploads/ScrollImage/1381906619_jcpao4_791_1364279943_qg83i3_3808.jpg" alt="1" width="730" height="300"></a></div>
				<div><a href="#" title="2"><img src="/laughcms/uploads/ScrollImage/1381906636_divy61_1524_1364280038_2l6n4e_8019.jpg" alt="2" width="730" height="300"></a></div>
				<div><a href="#" title="3"><img src="/laughcms/uploads/ScrollImage/1381906650_bz59w8_6658_1364280067_duvmp8_5013.jpg" alt="3" width="730" height="300"></a></div>
			</div>
	<div class="switcher">
...
$("#SImageContainer").Xslider({
	...
	<div id="CenterShow" class="block">
		<div class="boxBlock fleft w350">
			<div class="boxBlockTitle">
				...
				<span class="link"><a href="/laughcms/index.php?s=Article/index&columnid=2">更多>></a></span>
			</div>
		...
		<div class="boxBlock fleft w640 mleft10">
			...
			<div class="boxBlockBody h170">
				...
				<div class="boxBlockText fleft w450">
					...
					<a href="/laughcms/index.php?s=Public/index&columnid=10" class="viewbtn">阅读全文</a>
				</div>
			</div>
		</div>
		<div class="clear"></div>
	...
	<div class="adBanner block">
		<a href="#" target="_blank"><img src="/laughcms/uploads/AdImage/1381906677_6kn443_3809_1368168836_w2hsg2_8994_ad_banner2.png" width="1000" height="80" /></a>
	</div>
	<div id="BottomShow" class="block">
		<div id="ImgListBlock" class="boxBlock fleft w740">
	<div class="boxBlockTitle">
		<span class="title">产品展示</span>
		<span class="link"><a href="/laughcms/index.php?s=Product/index&columnid=6">更多>></a></span>
