	...
	<div id="HeaderMain">
		<div id="HeaderStatus">
			...
			<div class="Operate">
				...
				<div class="Search">
					<form method="POST" action="/index.php?s=Search">
...
<ul class="headerNavigation">
		<li>
		<a href="/index.php?s=Index/index&columnid=1" class="navon">网站首页</a>
			</li>
		<li>
		<a href="/index.php?s=Article/index&columnid=2" class="">新闻资讯</a>
				<ul class="SubNavigation">
						<li>
				<a href="/index.php?s=Article/index&columnid=3">IT知识</a>
								<ul>
										<li><a href="/index.php?s=Article/index&columnid=12">PHP知识</a></li>
									</ul>
							</li>
						<li>
				<a href="/index.php?s=Article/index&columnid=4">网络知识</a>
								<ul>
										<li><a href="/index.php?s=Article/index&columnid=5">前端知识</a></li>
									</ul>
							</li>
						<li>
				<a href="/index.php?s=Article/index&columnid=13">数据库知识</a>
							</li>
					</ul>
			</li>
		<li>
		<a href="/index.php?s=Product/index&columnid=6" class="">产品展示</a>
				<ul class="SubNavigation">
						<li>
				<a href="/index.php?s=Product/index&columnid=14">网络产品</a>
							</li>
						<li>
				<a href="/index.php?s=Product/index&columnid=15">电子产品</a>
							</li>
					</ul>
			</li>
		<li>
		<a href="/index.php?s=Image/index&columnid=7" class="">客户案例</a>
			</li>
		<li>
		<a href="/index.php?s=Download/index&columnid=8" class="">下载中心</a>
			</li>
		<li>
		<a href="/index.php?s=Plugin/Cooperate&columnid=9" class="">招贤纳士</a>
			</li>
		<li>
		<a href="/index.php?s=Public/AboutUS&columnid=10" class="">关于我们</a>
			</li>
		<li>
		<a href="/index.php?s=Public/ContactUS&columnid=11" class="">联系我们</a>
			</li>
	</ul>
...
<div id="SImageContainer" class="slider">
	<div class="conbox">
				<div><a href="#" title="剑侠情缘叁明教"><img src="/Uploads/ScrollImage/1364279943_qg83i3_3808.jpg" alt="剑侠情缘叁明教" width="730" height="300"></a></div>
				<div><a href="#" title="绿色屏保"><img src="/Uploads/ScrollImage/1364280038_2l6n4e_8019.jpg" alt="绿色屏保" width="730" height="300"></a></div>
				<div><a href="#" title="豪车"><img src="/Uploads/ScrollImage/1364280067_duvmp8_5013.jpg" alt="豪车" width="730" height="300"></a></div>
			</div>
	<div class="switcher">
...
$("#SImageContainer").Xslider({
	...
	<div id="CenterShow" class="block">
		<div class="boxBlock fleft w350">
			<div class="boxBlockTitle">
				...
				<span class="link"><a href="/index.php?s=Article/index&columnid=2">更多>></a></span>
			</div>
			<div class="boxBlockBody h170">
				<ul class="articleList">
					
					<li><a href="/index.php?s=Article/view&columnid=3&archiveid=18">VI命令大全</a></li>
					
					<li><a href="/index.php?s=Article/view&columnid=4&archiveid=13">DNS污染【备忘】</a></li>
					
					<li><a href="/index.php?s=Article/view&columnid=12&archiveid=10">Web服务攻击反侦查痕迹检测</a></li>
					
					<li><a href="/index.php?s=Article/view&columnid=3&archiveid=8">PHP单例模式经典讲解</a></li>
					
					<li><a href="/index.php?s=Article/view&columnid=2&archiveid=1">这是一篇测试文章</a></li>
		...
		<div class="boxBlock fleft w640 mleft10">
			...
			<div class="boxBlockBody h170">
				...
				<div class="boxBlockText fleft w450">
					...
					<a href="/index.php?s=Public/AboutUS&columnid=10" class="viewbtn">阅读全文</a>
				</div>
			</div>
		</div>
		<div class="clear"></div>
	...
	<div class="adBanner block">
		<a href="http://www.baidu.com/" target="_blank"><img src="/Uploads/AdImage/1368168531_sqifub_4518_ad_banner0.png" width="1000" height="80" /></a>
	</div>
	<div id="BottomShow" class="block">
		<div id="ImgListBlock" class="boxBlock fleft w740">
	<div class="boxBlockTitle">
		<span class="title">产品展示</span>
		<span class="link"><a href="/index.php?s=Product/index&columnid=6">更多>></a></span>
	...
	<div class="boxBlockBody h350">
			...
			<ul class="ProductList h335">
												<li>
					<a class="img" href="/index.php?s=Product/view&columnid=14&archiveid=12"><img src="/Uploads/Image/201304/02/1364884946_37uz4d_4967.png" /></a>
					<a class="title" href="/index.php?s=Product/view&columnid=14&archiveid=12">Vim文本编辑器 v7.3 正式版</a>
				</li>
								<li>
					<a class="img" href="/index.php?s=Product/view&columnid=14&archiveid=11"><img src="/Uploads/Image/201304/02/1364884636_tpajd4_786.png" /></a>
					<a class="title" href="/index.php?s=Product/view&columnid=14&archiveid=11">4 款 Linux 下开源的个人日记管理软件</a>
				</li>
											</ul>
		</div>
			...
			<ul class="ProductList h335">
												<li>
					<a class="img" href="/index.php?s=Product/view&columnid=15&archiveid=9"><img src="/Uploads/Image/201304/02/1364884203_zxvkaj_4664.png" /></a>
					<a class="title" href="/index.php?s=Product/view&columnid=15&archiveid=9">Web服务攻击反侦查痕迹检测</a>
				</li>
											</ul>
		</div>
					</div>
