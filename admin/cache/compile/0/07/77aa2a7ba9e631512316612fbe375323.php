...
<div class="formContainer" accessStatus=1>
	...
	<form name="newform" action="/laugh/admin/index.php?s=CTModel/saveEditSinglePage" enctype="multipart/form-data" method="post" class="newform">
		<input type="hidden" name="singlepageid" value="1" />
		<ul class="formbody">
			...
			<div class="shtabcontent shtabcontentcurrent">
				<li class="formblock">
					<span>文档标题:</span>
					<input type="text" name="title" value="关于我们页面123" class="input w300" />
				</li>
				<li class="formblock">
					<span>文档标签:</span>
				...
				<li class="formblock">
					<span>发布时间:</span>
					<input type="text" id="dpicker0" name="publishtime" value="2013-04-03 15:47:45" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input w150" />
			...
			<div class="shtabcontent">
				<li class="formblock">
					<span>SEO标题:</span>
					<input type="text" name="seotitle" value="关于我们页面123" class="input w300" />
				</li>
				...
				<li class="formautoblock">
					<span>摘要内容:</span>
					<textarea name="description" rows="2" cols="47">关于我们页面123</textarea>
				</li>
			</div>
			<div class="shtabcontent">
				<li class="formautoblock">
					...
					<div class="FullTextEditor">
						<textarea name="content" id="myEditor" rows="3" cols="50">&lt;p&gt;关于我们页面123&lt;/p&gt;</textarea>
					</div>
				</li>
			</div>
