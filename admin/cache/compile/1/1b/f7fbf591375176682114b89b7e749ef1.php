...
<div class="opTop">
	...
	<a href="/laugh/admin/index.php?s=Download/add" class="opTopOn">上传新文件</a>
	...
	<form name="newform" action="/laugh/admin/index.php?s=Download/save" enctype="multipart/form-data" method="post" class="newform">
		<ul class="formbody">
			...
			<div class="shtabcontent shtabcontentcurrent">
				...
				<li class="formblock">
					<span>发布时间:</span>
					<input type="text" id="dpicker0" name="publishtime" value="2013-04-27 18:55:13" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input w150" />
