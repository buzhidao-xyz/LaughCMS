...
<div class="formContainer" accessStatus=1>
	...
	<form name="newform" action="/laugh/admin/index.php?s=Image/save" enctype="multipart/form-data" method="post" class="newform">
		<ul class="formbody">
			...
			<div class="shtabcontent shtabcontentcurrent">
				...
				<li class="formblock">
					<span>发布时间:</span>
					<input type="text" id="dpicker0" name="publishtime" value="2013-04-27 13:29:37" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input w150" />
	...
	<div id="imageBody">
		...
		<div id="imageUploadBox" ajaxUrl="/laugh/admin/index.php?s=Image/saveUploadImage">
			...
			<span>
				<input type="hidden" name="imageUploadAction" value="Album" />
