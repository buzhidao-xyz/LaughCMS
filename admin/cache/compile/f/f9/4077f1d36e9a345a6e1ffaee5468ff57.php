...
<div class="opTop">
	...
	<a href="/laugh/admin/index.php?s=Article/add" class="opTopOn">发布新文章</a> |
	<a href="/laugh/admin/index.php?s=Article/recover">回收站</a>
</div>
<div class="formContainer" accessStatus=1>
	<div class="formtitle"><h5>创建新文档</h5></div>
	<form name="newform" action="/laugh/admin/index.php?s=Article/save" enctype="multipart/form-data" method="post" class="newform">
		<ul class="formbody">
			...
			<div class="shtabcontent shtabcontentcurrent">
				...
				<li class="formblock">
					<span>发布时间:</span>
					<input type="text" id="dpicker0" name="publishtime" value="2013-04-28 11:24:05" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input w150" />
