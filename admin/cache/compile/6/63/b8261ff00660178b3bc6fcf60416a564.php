		...
		<ul class="formbody">
			...
			<div class="shtabcontentc">
						...
						<input type="text" name="host" value="http://localhost:82/laugh" class="input w350" />
																			...
																			<li class="formblockauto">
						<span>网站名称:</span>
						<input type="text" name="sitename" value="昆山信德佳电气科技有限公司" class="input w350" />
					</li>
																			<li class="formblockauto">
						<span>网站关键字:</span>
						<textarea name="keywords" rows="4" cols="47">昆山,信德佳,昆山信德佳,电气,设备,电力,电网,监控</textarea>
					</li>
																			<li class="formblockauto">
						<span>网站描述:</span>
						<textarea name="description" rows="4" cols="47">昆山信德佳电气科技有限公司</textarea>
					</li>
																			<li class="formblockauto">
						<span>首页网站标题:</span>
						<input type="text" name="HomeSiteTitle" value="昆山信德佳电气科技有限公司" class="input w350" />
					</li>
												</div>
						...
						<div class="item_list fleft">
							...
							<label><input type="radio" name="archive_recover" value="0" class="radio"  />否</label>
																			...
																			<li class="formblockauto">
						<span>联系我们基本信息:</span>
						<textarea name="AboutUs" rows="4" cols="47"><h5><font color="#FF6600"><b>昆山信德佳电气科技有限公司</b></font></h5>
...
<h5>地 址: 江苏省昆山市苇城南路1699号工业技术研究院</h5></textarea>
					</li>
												</div>
									</div>
