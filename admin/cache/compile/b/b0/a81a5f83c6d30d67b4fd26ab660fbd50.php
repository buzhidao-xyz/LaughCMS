...
<div class="formContainer" accessStatus=1>
	...
	<form name="newform" action="/admin/?s=Group/saveGroup" method="post" id="addajaxform" class="newform">
...
<div class="contentTableList">
		...
		<li class="table_list_l table_list_l100">显</li>
			...
			<a delurl="/admin/Group/deleteGroup" href="javascript:;" name="del" msg="确定删除吗？">删除</a>
		</li>
			</ul>
		<ul class="table_list">
...
<div id="modify_div" class="modify_div" style="display:none;" accessStatus=1>
	...
	<form id="modify_div_form" action="/admin/?s=Group/upGroup">
