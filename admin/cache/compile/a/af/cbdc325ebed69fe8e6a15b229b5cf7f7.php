...
<div class="formContainer" accessStatus=1>
	...
	<form name="newcolumnform" action="/laugh/admin/index.php?s=Column/saveUpdateColumn" enctype="multipart/form-data" method="post" class="newform">
		<input type="hidden" name="columnid" value="4" />
		<ul class="formbody">
			...
			<div class="shtabcontent shtabcontentcurrent">
				<li class="formblock">
					...
					<select id="select" name="parentid" style="width:230px;">
						<option value="">|-请选择栏目...</option><option value="1">&nbsp;&nbsp;|-网站首页</option><option value="4">&nbsp;&nbsp;|-栏目2</option><option value="2" >&nbsp;&nbsp;&nbsp;&nbsp;|-子栏目1</option><option value="3" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|-子子栏目1</option>
					</select>
				</li>
				<li class="formblock">
					<span>栏目名称:</span>
					<input type="text" name="columnname" value="栏目2" class="input w200" />
				</li>
				<li class="formblock">
					<span>排列顺序:</span>
			...
			<div class="shtabcontent">
				<li class="formautoblock">
					...
					<div class="FullTextEditor">
						<textarea name="content" id="myEditor" rows="3" cols="50">&lt;p&gt;栏目2&lt;br /&gt;&lt;/p&gt;</textarea>
					</div>
				</li>
			</div>
