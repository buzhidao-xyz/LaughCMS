...
<div class="boxPopupForm">
	...
	<div class="boxMessage">
		<div class="message"><font color="green">数据库还原成功!还原版本:<br/>laugh_DataBase_20131004.sql</font></div>
		<div class="jump">
			页面即将自动跳转 
			等待时间 <b id="wait">3</b> 秒
		</div>
		<div class="jumpUrl">
			<a id="href" href="http://localhost/laugh/admin/index.php?s=DataBase/BackUp">如果你的浏览器没反应，请点击这里...</a>
		</div>
	</div>
</div>
</div>
