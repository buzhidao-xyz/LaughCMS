...
<div class="formContainer" accessStatus=1>
	...
	<form name="newcolumnform" action="/laugh/admin/index.php?s=Column/saveUpColumn" enctype="multipart/form-data" method="post" class="newform">
		<input type="hidden" name="columnid" value="9" />
		<ul class="formbody">
			...
			<div class="shtabcontent shtabcontentcurrent">
				...
				<li class="formblock">
					...
					<select name="columnmodel" style="width:230px;">
						<option value="">|-请选择内容模型...</option><option value="1">&nbsp;&nbsp;|-文章模型</option><option value="2">&nbsp;&nbsp;|-图片模型</option><option value="3">&nbsp;&nbsp;|-下载模型</option><option value="4">&nbsp;&nbsp;|-专题模型</option><option value="5">&nbsp;&nbsp;|-软件模型</option><option value="6">&nbsp;&nbsp;|-产品模型</option><option value="7">&nbsp;&nbsp;|-分类信息模型</option><option value="8">&nbsp;&nbsp;|-公共模型</option><option value="9" selected>&nbsp;&nbsp;|-插件模型</option>
					</select>
				</li>
				<li class="formblock">
					<span>栏目名称:</span>
					<input type="text" name="columnname" value="招贤纳士" class="input w200" />
				</li>
				<li class="formblock">
					<span>访问Action:</span>
				...
				<li class="formblock">
					<span>排列顺序:</span>
					<input type="text" name="sortrank" value="6" class="input w100" />
				</li>
