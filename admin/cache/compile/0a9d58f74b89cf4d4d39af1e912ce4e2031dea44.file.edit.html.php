<?php /* Smarty version Smarty-3.1.12, created on 2013-04-11 16:41:44
         compiled from "C:\xampp\htdocs\laugh\admin\themes\green\Download\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:2892651667748d37634-13280931%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a9d58f74b89cf4d4d39af1e912ce4e2031dea44' => 
    array (
      0 => 'C:\\xampp\\htdocs\\laugh\\admin\\themes\\green\\Download\\edit.html',
      1 => 1365586017,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2892651667748d37634-13280931',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51667748eb4199_78897683',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51667748eb4199_78897683')) {function content_51667748eb4199_78897683($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("public/control_top.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

<?php if ($_smarty_tpl->tpl_vars['accessStatus']->value==1){?>
<div class="formContainer" accessStatus=<?php echo $_smarty_tpl->tpl_vars['accessStatus']->value;?>
>
	<div class="formtitle"><h5>修改文档资料</h5></div>
	<form name="newform" action="__APP__/index.php?s=Download/saveEdit" enctype="multipart/form-data" method="post" class="newform">
...
" class="input w300" />
			...
			<div class="shtabcontent">
				<li class="formautoblock">
					<div id="fileBox">
						<?php if (isset($_smarty_tpl->tpl_vars['ArchiveInfo']->value['attachment'])&&!empty($_smarty_tpl->tpl_vars['ArchiveInfo']->value['attachment'])){?>
						<div class="fileBoxName">
							<font color="#4E4E4E">文件名称: </font>
							<font color="#747474"><?php echo $_smarty_tpl->tpl_vars['ArchiveInfo']->value['attachment']['filename'];?>
</font>
						</div>
						<div class="fileBoxSize">
							<font color="#4E4E4E">文件大小: </font>
							<font color="#747474"><?php echo formatBytes($_smarty_tpl->tpl_vars['ArchiveInfo']->value['attachment']['filesize']);?>
</font>
						</div>
						<div class="fileBoxNum">
							<font color="#4E4E4E">下载次数: </font>
							<font color="#747474"><?php echo $_smarty_tpl->tpl_vars['ArchiveInfo']->value['attachment']['downloadnum'];?>
 次</font>
						</div>
						<?php }?>
					</div>
