...
<div id="control">
	...
	<div class="captitle"><h5>兑奖申请列表【目前共有7条数据】</h5></div>
    <ul class="table_list_title">
    	...
    	<li class="table_list_l table_list_l120">1332390538</li>
        ...
        <ul class="table_list">
		<li class="table_list_l table_list_l150">测试组</li>
    	<li class="table_list_l table_list_l120">1350897953</li>
    	<li class="table_list_l table_list_l100">显</li>
    	<li class="table_list_l table_list_l150">
    		<a href="javascript:;" name="modify">修改</a>&nbsp;&nbsp;
    		<a delurl="/laugh/admin/Group/deleteGroup" href="javascript:;" name="del" msg="确定删除吗？">删除</a>
        ...
        <ul class="table_list">
		<li class="table_list_l table_list_l150">测试组</li>
    	<li class="table_list_l table_list_l120">1350898030</li>
    	<li class="table_list_l table_list_l100">显</li>
    	<li class="table_list_l table_list_l150">
    		<a href="javascript:;" name="modify">修改</a>&nbsp;&nbsp;
    		<a delurl="/laugh/admin/Group/deleteGroup" href="javascript:;" name="del" msg="确定删除吗？">删除</a>
