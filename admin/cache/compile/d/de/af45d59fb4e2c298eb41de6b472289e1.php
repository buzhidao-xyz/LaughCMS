...
<div class="opTop">
	...
	<a href="/laugh/admin/index.php?s=Plugin/CooperateAdd" class="opTopOn">发布新招聘信息</a>
</div>
	...
	<form name="newform" action="/laugh/admin/index.php?s=Plugin/CooperateSave" enctype="multipart/form-data" method="post" class="newform" id="ajaxform">
		<ul class="formbody">
			...
			<div class="shtabcontent shtabcontentcurrent">
				...
				<li class="formblock">
					<span>发布时间:</span>
					<input type="text" id="dpicker0" name="publishtime" value="2013-05-09 16:18:08" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input w150" />
