...
<div class="contentTableList">
		...
		<li class="table_list_l table_list_l150">2013-01-24 16:19:34</li>
		<li class="table_list_l table_list_l120">127.0.0.1</li>
		<li class="table_list_l table_list_l80">102</li>
		...
		<li class="table_list_l table_list_l80">12</li>
				<li class="table_list_l table_list_l80" accessStatus=1>
							<a delurl="/laugh/admin/index.php?s=Admin/upAdminStatus&id=2&status=0" href="javascript:;" name="del" msg="确定禁用吗？">启用</a>
					</li>
		<li class="table_list_l table_list_l150" accessStatus=1>
...
<div id="modify_div" class="modify_div" style="display:none;" accessStatus=1>
	...
	<form id="user_role_modify_div_form" action="/laugh/admin/index.php?s=Admin/roleAdmin">
