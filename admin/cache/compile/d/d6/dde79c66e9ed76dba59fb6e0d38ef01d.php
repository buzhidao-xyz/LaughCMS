...
<div class="contentTableList">
    	...
    	<li class="table_list_l table_list_l150">2012-03-22 12:47:51</li>
    		...
    		<a delurl="/admin/index.php?s=Role/upRoleStatus&id=1&status=0" href="javascript:;" name="del" msg="确定禁用吗？">启用</a>
    	</li>
    	<li class="table_list_l table_list_l150" accessStatus=1>
    		<a href="/admin/index.php?s=Role/newRole&id=1">修改</a>&nbsp;&nbsp;
    		<a delurl="/admin/index.php?s=Role/deleteRole&id=1" href="javascript:;" name="del" msg="确定删除吗？">删除</a>
    	</li>
            </ul>
        <ul class="table_list">
    	...
    	<li class="table_list_l table_list_l150">2012-03-22 12:47:51</li>
            	<li class="table_list_l table_list_l100" accessStatus=1>
    		<a delurl="/admin/index.php?s=Role/upRoleStatus&id=2&status=0" href="javascript:;" name="del" msg="确定禁用吗？">启用</a>
    	</li>
    	<li class="table_list_l table_list_l150" accessStatus=1>
    		<a href="/admin/index.php?s=Role/newRole&id=2">修改</a>&nbsp;&nbsp;
    		<a delurl="/admin/index.php?s=Role/deleteRole&id=2" href="javascript:;" name="del" msg="确定删除吗？">删除</a>
    	</li>
            </ul>
        </div>
