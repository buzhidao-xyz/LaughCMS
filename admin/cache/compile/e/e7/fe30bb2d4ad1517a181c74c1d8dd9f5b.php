...
<div class="formContainer" accessStatus=1>
	...
	<form name="newform" action="/laugh/admin/index.php?s=Plugin/CooperateEditSave" enctype="multipart/form-data" method="post" class="newform" id="ajaxform">
		<input type="hidden" name="cooperateid" value="3" />
		<ul class="formbody">
			...
			<div class="shtabcontent shtabcontentcurrent">
				<li class="formblock">
					<span>招聘职位:</span>
					<input type="text" name="position" value="PHP工程师" class="input w300" />
				</li>
				<li class="formblock">
					<span>选择发布栏目: </span>
				...
				<li class="formblock">
					<span>招聘人数:</span>
					<input type="text" name="quantity" value="10" class="input w100" /> 人
				</li>
				<li class="formblock">
					<span>学历要求:</span>
				...
				<li class="formblock">
					<span>更新时间:</span>
					<input type="text" id="dpicker0" name="updatetime" value="2013-04-15 09:31:42" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="input w150" />
			...
			<div class="shtabcontent">
				<li class="formautoblock">
					...
					<div class="FullTextEditor">
						<textarea name="description" id="myEditor" rows="3" cols="50">&lt;p&gt;1.熟练掌握 PHP、MySQL，对 Web 性能、安全有了解和实践经验，了解 HTML、CSS 等前端开发语言&lt;br /&gt;2.熟悉面向对象编程，至少掌握一种 PHP 框架的使用&lt;br /&gt;3.在一年内具有项目经验，开发代码在 3 万行以上&lt;br /&gt;4.熟悉 Kohana、CodeIgniter 等 MVC 框架优先&lt;br /&gt;5.有 Linux 服务器运维经验优先&lt;br /&gt;6.有 Python、Ruby、Java 编程经验优先&lt;/p&gt;</textarea>
					</div>
				</li>
			</div>
