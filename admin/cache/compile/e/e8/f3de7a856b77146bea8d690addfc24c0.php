...
<div class="formContainer" accessStatus=1>
	...
	<form name="newform" action="/laugh/admin/index.php?s=Advertise/saveHomeCenterAd" method="post" class="newform" enctype="multipart/form-data">
		<ul class="formbody">
			<li class="formblock">
				<span>图片:</span>
...
<div class="captitle"><h5>首页中部banner列表【总计4】</h5></div>
...
<div class="contentTableList">
		...
		<li class="table_list_l table_list_l250" title="首页Banner">首页Banner</li>
